# Contributing to Better San Carlos

Thank you for your interest in contributing to Better San Carlos! This civic-tech project thrives on community participation. Whether you're a developer, designer, translator, or a concerned citizen of San Carlos City, Pangasinan, your contributions are welcome.

## Project Architecture

Better San Carlos is a single Next.js + TypeScript application located at the repository root. The legacy static HTML version and the separate `react-app/` directory have been retired. The `main` branch now contains the active Next.js application.
...
1. Check existing [issues](https://github.com/BetterSanCarlos/bettersancarlos/issues) to avoid duplicates
...
- **LinkedIn:** [Connect with us](https://www.linkedin.com/company/bettersancarlos)
...
Thank you for helping make government information accessible to the people of San Carlos City, Pangasinan.
