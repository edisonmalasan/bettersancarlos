/**
 * Weather & Map Section for Better San Carlos Homepage
 * Displays real-time weather data and interactive map of San Carlos, Pangasinan
...
(function () {
  ...
  const WeatherService = {
    CACHE_KEY: 'san-carlos_weather_cache',
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in San Carlos">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> San Carlos, Pangasinan
                            </div>
                        </div>
                    </div>
  ...
  // ============================================================================
  const MapComponent = {
    SAN CARLOS_CENTER: [16.5167, 121.1833],
    DEFAULT_ZOOM: 14,
    map: null,
    ...
    renderTextFallback(container) {
      ...
      container.innerHTML = `
            <iframe 
                ...
                title="Map of San Carlos, Pangasinan"
                loading="lazy">
            </iframe>
        `;
    ...
    initLeaflet(container) {
      try {
        ...
        // Add marker
        const marker = L.marker(this.SAN CARLOS_CENTER).addTo(this.map);
        marker.bindPopup('<strong>San Carlos Municipal Hall</strong><br>Pangasinan 3708');
