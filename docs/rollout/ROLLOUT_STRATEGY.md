...
**Reference Implementation:** BetterSanCarlos (GitHub)

## Executive Summary

This document serves as the authoritative "Source of Truth" for deploying the BetterLGU transparency platform. It outlines the mandatory design standards, data synchronization protocols, and architectural decisions required to scale the BetterSanCarlos template to other Local Government Units (LGUs). All contributors must adhere to the "Kapwa" design values and the data normalization standards defined herein to ensure the platform remains accessible, maintainable, and civic-centric.
...
| Feature         | **BetterSanCarlos A (Lightweight)** | **BetterSanCarlos B (Next.js/TS)**            |
| :-------------- | :------------------------------- | :----------------------------------------- |
