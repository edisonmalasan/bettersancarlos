...
Defines the homepage hero as a full-viewport cinematic video experience — footage fills the section behind the existing hero content, with readability guaranteed by baked-in blur plus a brand scrim, and with performance-conscious fallbacks (poster, mobile, reduced motion).
