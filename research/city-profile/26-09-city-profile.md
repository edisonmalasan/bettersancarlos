...
- A **wide orb** stating San Carlos is in the center of Pangasinan Province and that it became a City in **1965**.
- A **Philippine sun** acting as the hub of a wheel moving **three triangles** representing the three economic activities: **agriculture** (left flange), **commerce and industry** (top flange), and **tourism** (right flange).
