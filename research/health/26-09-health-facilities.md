...
# San Carlos City, Pangasinan — Health Facilities

## Scope

Hospitals and health facilities in San Carlos City, Pangasinan: names corroborated from official LGU and encyclopedia sources, plus health-related services. DOH license data is tracked in `health/26-09-doh-facilities.md`.

## Summary

A core list of hospitals/facilities is documented, but DOH accreditation, addresses, and contact details for most facilities are not yet verified and are flagged for manual confirmation.

## Findings

### Directory

| ID | Entity | Evidence | Status | Temporal | As of | Sources |
|---|---|---|---|---|---|---|
...
The city's online forms historically included health-office-related permit forms (electrical, sanitary, occupancy permits — mostly under the Engineering/Health permit stream). See `transparency/26-09-full-disclosure.md` for the Citizen's Charter which lists the City Health Office among service offices.
...
- **DOH facility masterlist** for San Carlos (hospital level/classification, bed count, accreditation) — query DOH's Facility List and PhilHealth's accredited facilities database offline/next phase.
- **RHU / Barangay Health Stations** per-barangay names and locations not found in accessible official sources.
- **Pharmacies, labs, dialysis centers, dental clinics** not yet compiled.
- 2024 LGU directory indicates the City Health Officer's office and a City Veterinarian exist; no published contact numbers beyond the 2017 historical ones.
...
|---|---|---|---|---|---|---|
| S1 | City Government of San Carlos | Evacuation routes and safe areas (archived, old site) | 2017 | 2026-09-04 | archived-official | https://web.archive.org/web/20170509201719/http://sancarloscitypangasinan.gov.ph/index.php/evacuation-routes-and-safe-areas-for-san-carlos-city/ |
