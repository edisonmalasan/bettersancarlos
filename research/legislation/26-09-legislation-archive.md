---
schema: research.v2
id: legislation-archive
title: Legislation Archive (Ordinances & Resolutions)
...
Known legislation and governance documents of San Carlos City, Pangasinan, plus the status of digital legislation sources. Until a full archive is obtained, treat this file as a stub/status report, not a complete legal record.

## Summary

The council legislation subdomain was unreachable during research and most ordinance texts are unobtained; only a handful of historical items (RA 4487, RA 4866, one 2016 ordinance heading) are documented. Known items below are historical and must be re-verified.

## Findings

### Source Availability

| Source | Status (2026-09-04) | Sources |
|---|---|---|
| Sangguniang Bayan subdomain (sangguniangbayan.sancarlospangasinan.gov.ph) | **Unreachable** (connection failed during research). Listed in project README as the ordinances/resolutions source. | S1 |
| Current official LGU site (sancarlospangasinan.gov.ph) | Links to Sangguniang Bayan pages but serves the same thin one-page site; no accessible ordinance PDFs found on the live/archived (2024) snapshots. | S1 |
| Old official site (sancarloscitypangasinan.gov.ph) | Had a **Legislative** page (archived 2017) showing 2016 ordinances/resolutions (e.g., "Ordinance No. 04-15" heading). Few texts preserved. | S2 |
...
- Full texts of city ordinances and resolutions (archive to be assembled once the council subdomain is reachable).
- Pangasinan-city EO series texts.
- Digitized historical ordinance record pre-2016.

### Where the Real Archives Likely Live
...
- **Official Gazette** for national acts affecting the city (RA 4487, etc.). | `S4`
...
- The 2021 EO series on `sancarloscity.gov.ph` belongs to San Carlos City, Negros Occidental and must be excluded from Pangasinan material.
...
- Attempted the council subdomain (connection failed), the live and archived LGU site (no ordinance PDFs), and the archived 2017 Legislative page (one heading recovered) on 2026-09-04. | `S1`, `S2`
