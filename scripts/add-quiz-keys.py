#!/usr/bin/env python3
"""
Add missing San Carlos Quiz and Quiz CTA translation keys to translations.js.
"""
...
# All the page-prefix variants for "San Carlos Quiz" footer link
prefixes = [
...
quiz_cta_en = {
    'home-san-carlos-quiz': 'San Carlos Quiz',
    'home-how-well-do-you-know-san-carlos-nueva-vizcaya': 'How well do you know San Carlos, Pangasinan?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Evaluate your familiarity with the municipality's heritage, cultural identity, and geographic significance through an interactive knowledge assessment designed to showcase one of Pangasinan's most prominent localities.",
    'home-take-the-quiz': 'Take the Quiz',
}

quiz_cta_fil = {
    'home-san-carlos-quiz': 'San Carlos Quiz',
    'home-how-well-do-you-know-san-carlos-nueva-vizcaya': 'Gaano mo kakilala ang San Carlos, Pangasinan?',
...
quiz_cta_ilo = {
    'home-san-carlos-quiz': 'San Carlos Quiz',
    'home-how-well-do-you-know-san-carlos-nueva-vizcaya': 'Kasano ti pannakaammom iti San Carlos, Pangasinan?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Evaluaren ti pannakaammom iti tawid, kultural a pagbigbigan, ken heograpiko a kapatgan ti munisipalidad babaen ti maysa nga interactive a panagsubok ti pannakaammo a naidisinio tapno ipakita ti maysa kadagiti kalatakan a lokalidad ti Pangasinan.",
...
def build_entries(lang):
    ...
    # Page-prefix San Carlos Quiz keys
    for prefix in prefixes:
        key = f'{prefix}-san-carlos-quiz'
        # "San Carlos Quiz" stays the same in all languages (it's a proper name)
        entries.append(f'        "{key}": "San Carlos Quiz"')
    
    # Quiz CTA keys
    if lang == 'en':
        for k, v in quiz_cta_en.items():
            # Skip home-san-carlos-quiz since it's already in the prefix list
            if k == 'home-san-carlos-quiz':
                continue
...
for k in ['home-take-the-quiz', 'home-how-well-do-you-know-san-carlos-nueva-vizcaya']:
