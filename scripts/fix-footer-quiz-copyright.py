...
1. Add San Carlos Quiz link before Sitemap in Quick Links
2. Update copyright to 3-span format with 2026 year
3. Add San Carlos Quiz entry to sitemap page
...
def fix_footer_quiz_link(content, filepath):
    """Add San Carlos Quiz link before Sitemap in footer Quick Links."""
    # Check if quiz link already exists
    if 'quiz.bettersancarlos.vercel.app' in content:
    ...
    quiz_link = f'<li><a href="https://quiz.bettersancarlos.vercel.app/" target="_blank" rel="noopener noreferrer" data-i18n="{prefix}-san-carlos-quiz">San Carlos Quiz</a></li>\n                        '
...
def fix_copyright(content, filepath):
    ...
    new_copyright = '''<div class="footer-copyright">
                    <span class="footer-copyright-text">&copy; 2026 BetterSanCarlos.org.</span>
    ...
    # Update "Better San Carlos" to "BetterSanCarlos.org" in copyright if still old
    if 'Better San Carlos. MIT' in content:
        content = content.replace('Better San Carlos. MIT', 'BetterSanCarlos.org. MIT')
        changed = True
...
def add_quiz_to_sitemap(content):
    """Add San Carlos Quiz entry to sitemap page content."""
    if 'quiz.bettersancarlos.vercel.app' in content:
        return content, False
    ...
    if match:
        quiz_entry = '\n                        <a href="https://quiz.bettersancarlos.vercel.app/" target="_blank" rel="noopener noreferrer" class="sitemap-link-item sitemap-link-item--external"><i class="bi bi-box-arrow-up-right"></i> <span data-i18n="sitemap-san-carlos-quiz">San Carlos Quiz</span></a>'
...
for filepath in html_files:
    ...
    # Fix 1: Add San Carlos Quiz footer link
