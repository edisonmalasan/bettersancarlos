...
FIL2 = {
    ...
    "Registration of birth for children born in San Carlos, Pangasinan": "Pagpaparehistro ng kapanganakan para sa mga batang ipinanganak sa San Carlos, Pangasinan",
    "Registration of death for persons who died in San Carlos, Pangasinan": "Pagpaparehistro ng pagkamatay para sa mga taong namatay sa San Carlos, Pangasinan",
    ...
    "Certification that a person has no declared property in San Carlos.": "Sertipikasyon na ang isang tao ay walang idineklaang ari-arian sa San Carlos.",
    ...
    "For engaged couples intending to get married in San Carlos": "Para sa mga magkasintahang nagbabalak magpakasal sa San Carlos",
...
FIL3 = {
    # Business/Permits
    "Application for new business permit for businesses operating in San Carlos": "Aplikasyon para sa bagong permiso sa negosyo para sa mga negosyong nag-ooperate sa San Carlos",
    ...
    "What do I need to start a new business in San Carlos?": "Ano ang kailangan ko upang magsimula ng bagong negosyo sa San Carlos?",
    ...
    "Tax declaration form for real property assessment in San Carlos, Pangasinan": "Form ng tax declaration para sa pagtatasa ng tunay na ari-arian sa San Carlos, Pangasinan",
...
FIL4 = {
    ...
    "Proof of residence in San Carlos": "Patunay ng paninirahan sa San Carlos",
...
FIL5 = {
    ...
    "Farm registration, certifications, and agricultural programs for San Carlos farmers": "Pagpaparehistro ng bukid, mga sertipikasyon, at mga programang agrikultural para sa mga magsasaka ng San Carlos",
    ...
    "Support programs for corn farmers in San Carlos": "Mga programa ng suporta para sa mga magsasaka ng mais sa San Carlos",
...
FIL7 = {
    # Privacy Policy
    "This Privacy Policy explains how BetterSanCarlos.org collects, uses, and protects your information": "Ang Patakaran sa Privacy na ito ay nagpapaliwanag kung paano kinokolekta, ginagamit, at pinoprotektahan ng BetterSanCarlos.org ang iyong impormasyon",
    ...
    "These Terms of Use govern your access to and use of the BetterSanCarlos.org website": "Ang mga Tuntunin ng Paggamit na ito ay namamahala sa iyong pag-access at paggamit ng website ng BetterSanCarlos.org",
    ...
    "All content on this website is the property of BetterSanCarlos.org unless otherwise stated": "Ang lahat ng nilalaman sa website na ito ay pag-aari ng BetterSanCarlos.org maliban kung iba ang nakasaad",
    ...
    "Find answers to common questions about San Carlos municipal services": "Maghanap ng mga sagot sa mga karaniwang tanong tungkol sa mga serbisyo ng munisipyo ng San Carlos",
    "Is this website mobile-friendly?": "Ang website ba na ito ay mobile-friendly?",
    "Who developed Better San Carlos?": "Sino ang gumawa ng Better San Carlos?",
    ...
    "Data and statistics about San Carlos, Pangasinan": "Datos at estadistika tungkol sa San Carlos, Pangasinan",
    ...
    "San Carlos at a Glance": "San Carlos sa Isang Tingin",
    "Brief History of San Carlos": "Maikling Kasaysayan ng San Carlos",
    "Major development projects serving the community": "Mga pangunahing proyekto ng pagpapaunlad na nagsisilbi sa komunidad",
    "DPWH Infrastructure Projects in San Carlos": "Mga Proyekto ng Imprastraktura ng DPWH sa San Carlos",

    # Home page
    "Welcome to Better San Carlos": "Maligayang Pagdating sa Better San Carlos",
    "Your gateway to San Carlos municipal services and information": "Ang iyong daan patungo sa mga serbisyo at impormasyon ng munisipyo ng San Carlos",
    "Fetching news and updates from San Carlos.": "Kinukuha ang mga balita at update mula sa San Carlos.",
    "Fetching the latest news from San Carlos.": "Kinukuha ang pinakabagong balita mula sa San Carlos.",
    "Stay informed about the latest happenings in San Carlos": "Manatiling may kaalaman tungkol sa mga pinakabagong pangyayari sa San Carlos",
    ...
    "Get in touch with the municipal government of San Carlos": "Makipag-ugnayan sa pamahalaang munisipal ng San Carlos",
...
KEEP_AS_IS = {
    'BLGF Portal', 'CMCI DTI Portal', 'LGU San Carlos Facebook',
    ...
    'BetterSanCarlos.org', 'Better San Carlos', 'Abakada.org',
    'Sangguniang Bayan', 'Sangguniang Panlalawigan',
    'Pangasinan', 'San Carlos', 'Bayombong', 'Facebook', 'Google',
}
