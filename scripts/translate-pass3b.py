...
PHRASES_FIL = {
    ...
    "Better San Carlos is committed to ensuring digital accessibility for people with disabilities": "Ang Better San Carlos ay nakatuon sa pagtiyak ng digital na accessibility para sa mga taong may kapansanan",
    "Better San Carlos is committed to ensuring that our digital services are accessible to all citizens, regardless of ability": "Ang Better San Carlos ay nakatuon sa pagtiyak na ang aming mga digital na serbisyo ay naa-access ng lahat ng mamamayan, anuman ang kakayahan",
    ...
    "BetterSanCarlos.org is a civic platform dedicated to empowering the people of San Carlos by providing transparent access to": "Ang BetterSanCarlos.org ay isang civic platform na nakatuon sa pagbibigay-kapangyarihan sa mga tao ng San Carlos sa pamamagitan ng pagbibigay ng transparent na access sa",
    "BetterSanCarlos.org is a general audience website providing civic information": "Ang BetterSanCarlos.org ay isang website para sa pangkalahatang madla na nagbibigay ng civic na impormasyon",
    "BetterSanCarlos.org provides public domain information to support civic engagement, transparency, and informed participation": "Ang BetterSanCarlos.org ay nagbibigay ng impormasyon sa public domain upang suportahan ang civic engagement, transparency, at may kaalamang pakikilahok",
    "BetterSanCarlos.org values accuracy, public safety, and respect for rights": "Pinahahalagahan ng BetterSanCarlos.org ang katumpakan, kaligtasan ng publiko, at paggalang sa mga karapatan",
    ...
    "BetterSanCarlos.org cannot guarantee that the website will be": "Hindi magagarantiya ng BetterSanCarlos.org na ang website ay magiging",
    ...
    "Official LGU San Carlos Portal": "Opisyal na Portal ng LGU San Carlos",
