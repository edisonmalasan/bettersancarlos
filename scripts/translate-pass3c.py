...
FIXES_FIL = {
    ...
    "While volunteers make every effort to secure BetterSanCarlos.org from online threats and keep information accurate, no system can be guaranteed to be perfectly secure, error-free, or completely up-to-date at all times.":
        "Bagaman ang mga boluntaryo ay nagsusumikap na pangalagaan ang BetterSanCarlos.org mula sa mga online na banta at panatilihing tumpak ang impormasyon, walang sistema ang maaaring garantiyahan na perpektong ligtas, walang error, o ganap na napapanahon sa lahat ng oras.",
}
