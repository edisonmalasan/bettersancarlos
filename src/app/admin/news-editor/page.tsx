...
export default function NewsEditorPage() {
    ...
    const neBtn =
        'cursor-pointer rounded-lg border border-line bg-white px-3 py-2 text-[#1f2937] transition-colors hover:border-[#3a7d44]';
    const neBtnPrimary = `${neBtn} border-[#3a7d44] bg-[#3a7d44] text-white hover:bg-[#2f6136]`;
    const neBtnSm =
        'cursor-pointer rounded-lg border border-line bg-white px-[9px] py-1 text-[0.78rem] text-[#1f2937] transition-colors hover:border-[#3a7d44]';
    ...
    const neInput = 'w-full rounded-lg border border-line bg-white px-2.5 py-2 text-[#1f2937] focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-[rgba(58, 125, 68,0.2)]';
    ...
    return (
        <>
            <header className="sticky top-0 z-[5] flex flex-wrap items-center gap-2.5 border-b border-line bg-white px-5 py-[14px]">
            ...
            <main className="grid grid-cols-[minmax(280px,360px)_1fr] items-start gap-[18px] px-5 py-[18px] max-[840px]:grid-cols-1">
                <section className="rounded-xl border border-line bg-white p-4" aria-label="Current entries">
                    ...
                    <div id="list">
                        ...
                        {sortedEntries.map(({ e, i }) => (
                            <div key={e.id + i} className={`mb-2.5 rounded-lg border px-3 py-2.5 ${i === editingIndex ? 'border-[#3a7d44] shadow-[0_0_0_2px_rgba(58, 125, 68,0.15)]' : 'border-line'}`}>
                ...
                <section className="rounded-xl border border-line bg-white p-4" aria-label="Editor">
                    ...
                    <div className="mt-[14px] border-t border-dashed border-line pt-[14px]">
                        ...
                        <article className="max-w-[360px] overflow-hidden rounded-xl border border-line bg-white">
