                ...
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6 max-[767px]:px-4 max-[480px]:px-2">
                    <div className="overflow-hidden rounded-xl border border-[#e5e7eb] bg-white">
                        ...
                        <div className="grid grid-cols-4 max-[992px]:grid-cols-2 max-[576px]:grid-cols-1">
                            <div className="flex flex-col items-center border-r border-[#e5e7eb] p-6 text-center last:border-r-0 max-[992px]:border-b max-[992px]:[&:nth-child(2)]:border-r-0 min-[577px]:max-[992px]:[&:nth-last-child(-n+2)]:border-b-0 max-[576px]:border-r-0 max-[576px]:[&:nth-last-child(-n+2)]:border-b max-[576px]:last:border-b-0">
            ...
            <section className="py-16 max-[1024px]:py-8 max-[767px]:py-6">
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6 max-[767px]:px-4 max-[480px]:px-2">
                    ...
                    <div className="grid grid-cols-3 gap-4 max-[992px]:grid-cols-2 max-[576px]:grid-cols-1">
                        <a href="tel:(075) 600-1432" className="flex items-center gap-3 rounded-lg border border-[#e5e7eb] bg-white px-4 py-3 text-foreground no-underline transition-all duration-200 hover:border-[#dc2626] hover:bg-[#fef2f2] hover:no-underline">
                        ...
                        <a href="tel:0623312067" className="flex items-center gap-3 rounded-lg border border-[#e5e7eb] bg-white px-4 py-3 text-foreground no-underline transition-all duration-200 hover:border-[#dc2626] hover:bg-[#fef2f2] hover:no-underline">
