                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex flex-col gap-2">
                                <details className="group overflow-hidden rounded-lg border border-line bg-white">
                                    <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-4 font-medium transition-colors duration-200 hover:bg-muted group-open:border-b group-open:border-line [&::-webkit-details-marker]:hidden">
