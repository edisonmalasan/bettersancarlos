                    ...
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 min-[1200px]:grid-cols-4 min-[1025px]:max-[1199px]:gap-4 max-[1024px]:grid-cols-2 max-[767px]:grid-cols-1" style={{ gap: 'var(--spacing-sm)' }}>
                        {barangays.map((b) => (
                            <Link
                                ...
                                className="flex flex-col justify-center rounded-[10px] border border-[#e5e7eb] bg-white px-4 py-3 text-[#2f3e46] no-underline transition-all duration-200 hover:-translate-y-0.5 hover:border-primary hover:no-underline hover:shadow-[0_4px_12px_rgba(58, 125, 68,0.1)]"
                            >
