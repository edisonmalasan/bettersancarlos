            ...
            <section className="py-16 max-[1024px]:py-8 max-[767px]:py-6" style={{ background: 'var(--color-bg-alt)' }}>
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6">
                    ...
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6 min-[1200px]:grid-cols-2 min-[1200px]:gap-8 max-[767px]:grid-cols-1" style={{ gap: 'var(--spacing-lg)' }}>
                        <div className="overflow-hidden rounded-[12px] border border-[#e5e7eb] bg-white transition-all duration-200 hover:border-primary hover:shadow-[0_4px_16px_rgba(58, 125, 68,0.1)]">
                            ...
                            <div className="px-8 py-6">
                                <div className="flex flex-col gap-2">
                                    <a href="mailto:CIO@sancarlospangasinan.com" className="flex items-center gap-2.5 rounded-lg bg-muted px-3 py-2.5 text-[0.875rem] text-[#1a1a1a] no-underline transition-all duration-200 hover:bg-[rgba(58, 125, 68,0.08)] hover:no-underline">
                                        <i className="bi bi-envelope text-[1rem] text-primary"></i>
                                        <span>CIO@sancarlospangasinan.com</span>
                                    </a>
                                    <a href="tel:(075) 600-1432" className="flex items-center gap-2.5 rounded-lg bg-muted px-3 py-2.5 text-[0.875rem] text-[#1a1a1a] no-underline transition-all duration-200 hover:bg-[rgba(58, 125, 68,0.08)] hover:no-underline">
                ...
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6">
                    ...
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6 min-[1200px]:grid-cols-3 max-[1024px]:grid-cols-2 max-[767px]:grid-cols-1" style={{ gap: 'var(--spacing-md)' }}>
                        {councilors.map((c) => (
                            <div
                                key={c.name}
                                className="rounded-[10px] border border-[#e5e7eb] border-l-[3px] border-l-primary bg-white p-6 transition-all duration-200 hover:border-primary hover:shadow-[0_4px_12px_rgba(58, 125, 68,0.08)] max-[767px]:p-4"
                            >
                    ...
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 min-[1200px]:grid-cols-4 min-[1025px]:max-[1199px]:gap-4 max-[1024px]:grid-cols-2 max-[767px]:grid-cols-1" style={{ gap: 'var(--spacing-sm)' }}>
                        {barangays.map((b) => (
                            <Link
                                ...
                                className="flex flex-col justify-center rounded-[10px] border border-[#e5e7eb] bg-white px-4 py-3 text-[#1a1a1a] no-underline transition-all duration-200 hover:-translate-y-0.5 hover:border-primary hover:no-underline hover:shadow-[0_4px_12px_rgba(58, 125, 68,0.1)]"
                            >
