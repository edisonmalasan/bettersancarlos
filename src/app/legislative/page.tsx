            ...
            <section className="bg-muted py-[60px] max-[768px]:py-10">
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6 max-[767px]:px-4 max-[480px]:px-2">
                    <div className="mb-8 text-center">
                        <span className="mb-2.5 inline-flex items-center gap-1.5 rounded-full bg-[rgba(0,50,160,0.08)] px-3 py-[5px] text-xs font-semibold text-primary"><i className="bi bi-diagram-3-fill"></i> Process Flow</span>
                        ...
                        <div className="grid grid-cols-4 gap-3 max-[1024px]:grid-cols-3 max-[768px]:grid-cols-2 max-[768px]:gap-2.5 max-[575px]:grid-cols-1">
                            {ordinanceSteps.map((step, index) => (
                                <div className="flex" key={step.number}>
                                    <div className={cn(
                                        'relative flex flex-1 flex-col rounded-lg border bg-white px-[14px] pb-[14px] pt-4 transition-all duration-200 hover:border-primary hover:shadow-[0_2px_12px_rgba(0,50,160,0.08)] max-[768px]:px-3 max-[768px]:pb-3 max-[768px]:pt-[14px] max-[575px]:flex-row max-[575px]:items-start max-[575px]:gap-3 max-[575px]:p-3',
            ...
            <section className="bg-white py-[60px] max-[768px]:py-10">
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6 max-[767px]:px-4 max-[480px]:px-2">
                    <div className="mx-auto max-w-full">
                        <div className="mb-8 text-center">
                            <span className="mb-2.5 inline-flex items-center gap-1.5 rounded-full bg-[rgba(0,50,160,0.08)] px-3 py-[5px] text-xs font-semibold text-primary"><i className="bi bi-info-circle-fill"></i> About</span>
                        ...
                        <div className="grid grid-cols-4 gap-3 max-[1024px]:grid-cols-2 max-[768px]:grid-cols-2 max-[768px]:gap-2.5 max-[575px]:grid-cols-1">
                            {infoCards.map((card) => (
                                <div className="flex flex-col rounded-lg border border-black/[0.06] bg-white p-4 text-left transition-all duration-200 hover:border-primary hover:shadow-[0_2px_12px_rgba(0,50,160,0.08)] max-[768px]:p-[14px] max-[575px]:flex-row max-[575px]:items-start max-[575px]:gap-3 max-[575px]:p-3" key={card.title}>
