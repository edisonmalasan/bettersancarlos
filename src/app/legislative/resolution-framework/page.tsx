                    ...
                    <tbody>
                        {items.map((item) => (
                            <tr key={item.resolutionNo} className="transition-colors hover:bg-muted [&:last-child>td]:border-b-0">
                                <td className="border-b border-[#faf9f6] px-4 py-3 max-[767px]:px-2"><span className="inline-block whitespace-nowrap rounded-md bg-[rgba(58, 125, 68,0.08)] px-2.5 py-1 text-xs font-semibold text-primary">{item.resolutionNo}</span></td>
                                ...
                                <td className="border-b border-[#faf9f6] px-4 py-3 max-[767px]:px-2"><span className="inline-block whitespace-nowrap rounded-full bg-[#e6f4ea] px-3 py-1 text-xs font-semibold text-success">SB Resolution</span></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
