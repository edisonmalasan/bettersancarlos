        ...
        <div className="mb-6 overflow-hidden rounded-xl border border-black/[0.06] bg-white shadow-[0_2px_4px_rgba(0,0,0,0.05)]" key={year}>
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-black/[0.06] p-6 max-[767px]:p-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-[rgba(0,50,160,0.08)] px-3 py-1 text-xs font-semibold text-primary"><i className="bi bi-calendar-check"></i> {year}</span>
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-[rgba(0,50,160,0.08)] px-3 py-1 text-xs font-semibold text-primary"><i className="bi bi-files"></i> {items.length} Records</span>
                </div>
            </div>
                    ...
                    <tbody>
                        {items.map((item) => (
                            <tr key={item.resolutionNo} className="transition-colors hover:bg-muted [&:last-child>td]:border-b-0">
                                <td className="border-b border-[#f8f9fa] px-4 py-3 max-[767px]:px-2"><span className="inline-block whitespace-nowrap rounded-md bg-[rgba(0,50,160,0.08)] px-2.5 py-1 text-xs font-semibold text-primary">{item.resolutionNo}</span></td>
