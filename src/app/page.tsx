...
const serviceCardCls =
  'group flex items-center gap-4 rounded-xl border border-[#e5e7eb] bg-white p-6 text-[#1a1a1a] no-underline transition-all hover:border-primary hover:shadow-[0_4px_12px_rgba(0,50,160,0.1)] hover:no-underline';
const statCardCls =
  'group relative flex items-center gap-4 overflow-hidden rounded-xl border border-[#e5e7eb] bg-white p-6 text-[#1a1a1a] no-underline transition-all duration-300 before:absolute before:left-0 before:top-0 before:h-full before:w-1 before:bg-[linear-gradient(180deg,#0032a0_0%,#003d82_100%)] before:opacity-0 before:transition-opacity before:duration-300 hover:-translate-y-0.5 hover:border-primary hover:shadow-[0_8px_24px_rgba(0,50,160,0.12)] hover:no-underline hover:before:opacity-100';
...
export default function HomePage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] py-[120px]">
        <div className={containerCls}>
          <div className="grid grid-cols-2 items-center gap-12 max-[992px]:grid-cols-1 max-[992px]:gap-8">
            ...
            <div>
              <div className="rounded-2xl border border-[rgba(0,50,160,0.08)] bg-white p-8 shadow-[0_8px_32px_rgba(0,50,160,0.1),0_2px_8px_rgba(0,0,0,0.04)] transition-[box-shadow,border-color] duration-300 focus-within:border-[rgba(0,50,160,0.15)] focus-within:shadow-[0_12px_40px_rgba(0,50,160,0.15),0_4px_12px_rgba(0,0,0,0.06)] max-[768px]:p-6">
                ...
                <form role="search" onSubmit={handleSearchSubmit}>
                  <div className="relative flex gap-2">
                    ...
                    <button type="submit" className="flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center rounded-[10px] border-0 bg-[linear-gradient(135deg,#0032a0_0%,#0044cc_100%)] text-[1.125rem] text-white shadow-[0_2px_8px_rgba(0,50,160,0.3)] transition-all hover:-translate-y-px hover:bg-[linear-gradient(135deg,#002170_0%,#003399_100%)] hover:shadow-[0_4px_12px_rgba(0,50,160,0.4)] active:translate-y-0" aria-label="Search">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2 text-[0.8125rem]">
                  ...
                  <Link href="/service-details/birth-certificate" className="rounded-full border border-transparent bg-[rgba(0,50,160,0.06)] px-3 py-[5px] font-medium text-primary no-underline transition-all hover:border-[rgba(0,50,160,0.15)] hover:bg-[rgba(0,50,160,0.1)] hover:no-underline">
                    {t('hero-birth-certificate')}
                  </Link>
                  <Link href="/service-details/business-permits-licensing" className="rounded-full border border-transparent bg-[rgba(0,50,160,0.06)] px-3 py-[5px] font-medium text-primary no-underline transition-all hover:border-[rgba(0,50,160,0.15)] hover:bg-[rgba(0,50,160,0.1)] hover:no-underline">
                    {t('hero-business-permit')}
                  </Link>
                  <Link href="/service-details/municipal-treasurer" className="rounded-full border border-transparent bg-[rgba(0,50,160,0.06)] px-3 py-[5px] font-medium text-primary no-underline transition-all hover:border-[rgba(0,50,160,0.15)] hover:bg-[rgba(0,50,160,0.1)] hover:no-underline">
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <div className="grid grid-cols-3 gap-6 max-[992px]:grid-cols-2 max-[768px]:grid-cols-1">
            ...
            <Link href="/services" className={cn(serviceCardCls, 'border-transparent bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] text-white hover:shadow-[0_4px_16px_rgba(0,50,160,0.3)]')}>
        ...
        <div className={containerCls}>
          ...
          <div className="grid grid-cols-4 gap-6 max-[992px]:grid-cols-2 max-[576px]:grid-cols-1">
            <Link href="/statistics" className={statCardCls}>
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[10px] bg-[#f8f9fa] text-xl text-primary transition-all duration-300 group-hover:bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] group-hover:text-white">
                <i className="bi bi-people-fill"></i>
              </div>
              <div className="min-w-0 flex-1">
                <span className="block text-2xl font-bold leading-[1.2] text-primary transition-colors group-hover:text-[#002170]">52,746</span>
            ...
            <Link href="/government" className={statCardCls}>
              ...
              <div className="min-w-0 flex-1">
                <span className="block text-2xl font-bold leading-[1.2] text-primary transition-colors group-hover:text-[#002170]">44</span>
            ...
            <Link href="/budget" className={statCardCls}>
              ...
              <div className="min-w-0 flex-1">
                <span className="block text-2xl font-bold leading-[1.2] text-primary transition-colors group-hover:text-[#002170]">1st Class</span>
            ...
            <Link href="/statistics" className={statCardCls}>
              ...
              <div className="min-w-0 flex-1">
                <span className="block text-2xl font-bold leading-[1.2] text-primary transition-colors group-hover:text-[#002170]">180.95 km²</span>
      ...
      <section className="bg-[linear-gradient(180deg,#f8f9fa_0%,#ffffff_100%)] py-16 max-[1024px]:py-8 max-[767px]:py-6">
        <div className={containerCls}>
          ...
          <div className="grid grid-cols-[1fr_340px] items-start gap-8 max-[900px]:grid-cols-1">
            <div className="relative pl-7 before:absolute before:bottom-2 before:left-1.5 before:top-2 before:w-0.5 before:rounded-sm before:bg-[linear-gradient(180deg,#0032a0_0%,rgba(0,50,160,0.2)_100%)]">
              {[
                ...
                <div key={item.year} data-year={item.year} className="group relative animate-[fadeInUp_0.5s_ease_forwards] pb-5 opacity-0 last:pb-0" style={{ animationDelay: item.delay }}>
                  <div className="absolute -left-7 top-1 z-[1] h-3.5 w-3.5 rounded-full border-[3px] border-primary bg-white transition-all group-hover:scale-125 group-hover:bg-primary group-hover:shadow-[0_0_0_4px_rgba(0,50,160,0.15)]"></div>
                  <div className="rounded-[10px] border border-black/[0.06] bg-white px-[18px] py-4 transition-all group-hover:translate-x-1 group-hover:border-primary group-hover:shadow-[0_4px_16px_rgba(0,50,160,0.1)]">
            ...
            <div className="sticky top-[100px] flex flex-col gap-4 max-[900px]:static max-[900px]:flex-row max-[900px]:flex-wrap max-[575px]:flex-col">
              <div className="flex items-start gap-3.5 rounded-xl border border-black/[0.06] bg-white p-5 transition-all hover:-translate-y-0.5 hover:border-primary hover:shadow-[0_4px_16px_rgba(0,50,160,0.1)] max-[900px]:flex-[1_1_280px] max-[575px]:flex-[1_1_100%]">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[10px] bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] [&_i]:text-xl [&_i]:text-white">
                  <i className="bi bi-geo-alt-fill"></i>
                </div>
                <div>
        ...
        <div className={containerCls}>
          ...
          <div className="grid grid-cols-2 gap-6 max-[768px]:grid-cols-1">
            <div className="rounded-xl border border-[#e5e7eb] bg-white p-8 text-center">
              <div className="mb-4 inline-block rounded-full bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] px-3.5 py-1.5 text-xs font-semibold text-white">{t('title-mayor')}</div>
            ...
            <div className="rounded-xl border border-[#e5e7eb] bg-white p-8 text-center">
              <div className="mb-4 inline-block rounded-full bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] px-3.5 py-1.5 text-xs font-semibold text-white">{t('title-vice-mayor')}</div>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <div className="grid grid-cols-3 gap-6 max-[992px]:grid-cols-1">
            <a href="tel:0623312067" className="flex items-start gap-4 rounded-xl border border-[#e5e7eb] bg-white p-6 text-[#1a1a1a] no-underline transition-all hover:border-primary hover:shadow-[0_4px_12px_rgba(0,50,160,0.08)] hover:no-underline">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[10px] bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] text-[1.125rem] text-white">
            ...
            <a href="mailto:CIO@sancarlospangasinan.com" className="flex items-start gap-4 rounded-xl border border-[#e5e7eb] bg-white p-6 text-[#1a1a1a] no-underline transition-all hover:border-primary hover:shadow-[0_4px_12px_rgba(0,50,160,0.08)] hover:no-underline">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[10px] bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] text-[1.125rem] text-white">
            ...
            <div className="flex items-start gap-4 rounded-xl border border-[#e5e7eb] bg-white p-6 text-[#1a1a1a] transition-all hover:border-primary hover:shadow-[0_4px_12px_rgba(0,50,160,0.08)]">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[10px] bg-[linear-gradient(135deg,#0032a0_0%,#003d82_100%)] text-[1.125rem] text-white">
                <i className="bi bi-geo-alt-fill"></i>
              </div>
              <div className="min-w-0 flex-1">
