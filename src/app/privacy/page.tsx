                    ...
                    <div className="grid grid-cols-[240px_1fr] items-start gap-12 max-[991px]:grid-cols-1 max-[991px]:gap-8">
                        ...
                        <article className="w-full max-w-[800px] max-[991px]:max-w-full">
                            ...
                            <section id="legal-basis" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Legal Basis for Processing</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="information-collected" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Information We Collect</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                                    We collect minimal information necessary to operate this civic platform
                                    effectively:
                                </p>

                                <h3 className="mb-3 mt-6 text-[1.125rem] font-bold text-[#2f3e46]">Information You Provide Voluntarily</h3>
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Email address (when you contact us or submit feedback)</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Name (if provided in correspondence)</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Message content and inquiries</li>
                                </ul>

                                <h3 className="mb-3 mt-6 text-[1.125rem] font-bold text-[#2f3e46]">Information Collected Automatically</h3>
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">IP address (anonymized where possible)</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Browser type and version</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Device type and operating system</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Pages visited and time spent on pages</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Referring website or source</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">General geographic location (country/region level)</li>
                                </ul>
                            ...
                            <section id="how-we-use" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">How We Use Your Information</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">We use the information we collect for the following purposes:</p>
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">To respond to your inquiries and feedback</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">To improve website functionality and user experience</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">To analyze website traffic and usage patterns</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">To ensure website security and prevent abuse</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">To comply with legal obligations</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">To maintain and improve civic services information</li>
                                </ul>
                            </section>
                            ...
                            <section id="cookies" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Cookies and Analytics</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                                    We use cookies and similar technologies to enhance your browsing experience:
                                </p>

                                <h3 className="mb-3 mt-6 text-[1.125rem] font-bold text-[#2f3e46]">Types of Cookies We Use</h3>
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">
                                ...
                                <h3 className="mb-3 mt-6 text-[1.125rem] font-bold text-[#2f3e46]">Google Analytics</h3>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                                ...
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Number of visitors and page views</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Traffic sources and user flow</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Device and browser information</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Geographic location (country/city level)</li>
                                </ul>
                                ...
                                <div className="my-6 rounded-[10px] border border-[rgba(0,0,0,0.08)] bg-white p-5 max-[575px]:p-4">
                                    ...
                                    <ul className="m-0 list-none p-0">
                                        <li className="relative mb-2 pl-5 text-[0.875rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:text-primary before:content-['→'] last:mb-0">You can disable cookies through your browser settings</li>
                                        ...
                                        <li className="relative mb-2 pl-5 text-[0.875rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:text-primary before:content-['→'] last:mb-0">Disabling cookies may affect some website functionality</li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section id="data-sharing" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Data Sharing and Disclosure</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="data-security" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Data Security</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                                    We implement appropriate technical and organizational measures to protect your
                                    personal information, including:
                                </p>
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">SSL/TLS encryption for data transmission</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Secure hosting infrastructure</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Regular security assessments</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Access controls and authentication</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Regular software updates and patches</li>
                                </ul>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="data-retention" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Data Retention</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="your-rights" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Your Rights Under the Data Privacy Act</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="childrens-privacy" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Children&apos;s Privacy</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="third-party" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Third-Party Links</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                            ...
                            <section id="changes" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Changes to This Privacy Policy</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                                ...
                                <ul className="my-4 list-none p-0">
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">The &quot;Last Updated&quot; date at the bottom of this page will be revised</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">Material changes may be announced on our website</li>
                                    <li className="relative mb-[10px] pl-6 text-[0.9375rem] leading-[1.6] text-[#2f3e46] before:absolute before:left-0 before:top-[10px] before:h-[6px] before:w-[6px] before:rounded-full before:bg-primary before:content-['']">
                            ...
                            <section id="contact" className="mb-12 border-b border-[rgba(0,0,0,0.06)] pb-12 last:mb-0 last:border-0 last:pb-0 max-[575px]:mb-8 max-[575px]:pb-8">
                                <h2 className="mb-4 inline-block border-b-2 border-primary pb-3 text-[1.5rem] font-bold text-[#2f3e46] max-[575px]:text-[1.25rem]">Contact Us</h2>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
                                ...
                                <h3 className="mb-3 mt-6 text-[1.125rem] font-bold text-[#2f3e46]">National Privacy Commission</h3>
                                <p className="mb-4 text-[0.9375rem] leading-[1.7] text-[#2f3e46] last:mb-0">
