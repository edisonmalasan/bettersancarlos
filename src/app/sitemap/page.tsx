                ...
                <div className="mx-auto w-full max-w-[1200px] min-[1025px]:max-[1199px]:max-w-[960px] px-6 max-[767px]:px-4 max-[480px]:px-2">
                    <div className="mb-12 last:mb-0">
                        <div className="mb-6 flex items-center gap-3 border-b-2 border-muted pb-4">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-[#003d82] max-[768px]:h-8 max-[768px]:w-8"><i className="bi bi-house-door text-base text-white max-[768px]:text-sm"></i></span>
                    ...
                    <div className="mb-12 last:mb-0">
                        <div className="mb-6 flex items-center gap-3 border-b-2 border-muted pb-4">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-[#003d82] max-[768px]:h-8 max-[768px]:w-8"><i className="bi bi-grid-3x3-gap text-base text-white max-[768px]:text-sm"></i></span>
                    ...
                    <div className="mb-12 last:mb-0">
                        <div className="mb-6 flex items-center gap-3 border-b-2 border-muted pb-4">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-[#003d82] max-[768px]:h-8 max-[768px]:w-8"><i className="bi bi-building text-base text-white max-[768px]:text-sm"></i></span>
                    ...
                    <div className="mb-12 last:mb-0">
                        <div className="mb-6 flex items-center gap-3 border-b-2 border-muted pb-4">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-[#003d82] max-[768px]:h-8 max-[768px]:w-8"><i className="bi bi-bank text-base text-white max-[768px]:text-sm"></i></span>
                    ...
                    <div className="mb-12 last:mb-0">
                        <div className="mb-6 flex items-center gap-3 border-b-2 border-muted pb-4">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-[#003d82] max-[768px]:h-8 max-[768px]:w-8"><i className="bi bi-link-45deg text-base text-white max-[768px]:text-sm"></i></span>
